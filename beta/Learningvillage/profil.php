...
$sql = "SELECT * FROM UTILISATEUR WHERE iduser = '".$_GET['id']."' "; 
...
Theme  suivie :
		...
		<?php	$sql = "SELECT * FROM INTERESSE WHERE iduser = '".$_GET['id']."' "; 
			$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
			...
			$sqll = "SELECT * FROM THEME WHERE idtheme = '".$idtheme."'"; 
