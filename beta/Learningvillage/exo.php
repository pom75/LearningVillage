...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<title>Learning village - Les Themes - Lecon - Tuto - Exo - Ajout</title>
...
?>
	...
	<FORM method=post action="exov.php<? echo '?id='.$_GET['id']; ?><?php echo '&idt='.$_GET['idt']; ?>">	
	<TR>
	<TD>Nom de l'exercice</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="nomexo"></TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TR>
	...
	<TD>
	<TEXTAREA rows="1" cols="10" name="nbetoile"></TEXTAREA>
	</TD>
	</TR>
	<br>
	<TD COLSPAN=2>
