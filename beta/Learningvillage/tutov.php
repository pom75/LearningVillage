...
try
{
	...
	$sql = "SELECT * FROM TUTO WHERE nomtuto = '$nomtuto' ";
	...
	$sql = "SELECT * FROM ESTFAITDE WHERE idtuto = '".$dn['idtuto']."' ";
	$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
	$dn = mysql_fetch_assoc($req);
	...
	$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
			...
			$sql = "SELECT * FROM THEME WHERE idtheme = '".$_GET['idt']."' "; 

			$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
			$dn = mysql_fetch_assoc($req);
			$nomt = $dn['nomtheme'];

			$sql = "SELECT * FROM INTERESSE WHERE idtheme = '".$_GET['idt']."' "; 
