...
<?php
				...
				$sql = "SELECT * FROM LECON WHERE idlecon = '".$_GET['id']."' "; 
				$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
...
?>
			<h1>Modifier la Lecon </h1>

	<FORM method=post action="leconmodd.php<?php echo '?id='.$_GET['id']; ?>">	
	<TR>
	<TD>Nom de la Lecon</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="nomlecon"><?php echo $dn['nomlecon'] ; ?> </TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TR>
