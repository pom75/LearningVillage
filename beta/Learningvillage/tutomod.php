...
<?php
				...
				$sql = "SELECT * FROM TUTO WHERE idtuto = '".$_GET['id']."' "; 
				$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
...
?>
			<h1>Modifier le tuto </h1>

	<FORM method=post action="tutonmodd.php<?php echo '?id='.$_GET['id']; ?>">	
	<TR>
	<TD>Nom de la Lecon</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="nomtuto"><?php echo $dn['nomtuto'] ; ?> </TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TR>
	...
	<TD>Niveau</TD><br>
	<TD>
	<TEXTAREA rows="2" cols="50" name="niveau"><?php echo $dn['niveau']; ?> </TEXTAREA>
	</TD>
	</TR>
	<br>
	<TD COLSPAN=2>
