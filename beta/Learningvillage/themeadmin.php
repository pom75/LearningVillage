...
<?php     if($_SESSION['prof']==0){
    ...
    ?>
		...
		<div id="corps">
			...
			<h1>Ajouter un admin Theme </h1>

	<FORM method=post action="themeadminn.php<?php echo '?id='.$_GET['id']; ?>">	
	<TR>
	<TD>Id de la personne a rajoutŽ</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="id"> </TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TD COLSPAN=2>
