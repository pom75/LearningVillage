...
<?php
				...
				$sql = "SELECT * FROM WORKGROUP WHERE idw = '".$_GET['id']."' "; 
				$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
...
?>
			<h1>Modifier le WG </h1>

	<FORM method=post action="workmodd.php<?php echo '?id='.$_GET['id']; ?>">	
	<TR>
	<TD>Nom du GW</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="nomw"><?php echo $dn['nomw'] ; ?> </TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TR>
