...
<?php
				...
				$sql = "SELECT * FROM EXO WHERE idexo = '".$_GET['id']."' "; 
				$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
...
?>
			<h1>Modifier l'exo </h1>

	<FORM method=post action="exomodd.php<?php echo '?id='.$_GET['id']; ?>">	
	<TR>
	<TD>Nom de l'exercice</TD><br>
	<TD>
	<TEXTAREA rows="1" cols="13" name="nomexo"><?php echo $dn['nomexo'] ; ?> </TEXTAREA>
	</TD>
	</TR>	
	<br>
	<TR>
	<TD>EnnooncŽ</TD><br>
	<TD>
	<TEXTAREA rows="2" cols="50" name="text"><?php echo $dn['text']; ?> </TEXTAREA>
	</TD>
	</TR>
	<br>
	<TD>nombre d'Žtoile</TD><br>
	<TD>
	<TEXTAREA rows="2" cols="50" name="nbetoile"><?php echo $dn['nbetoile']; ?> </TEXTAREA>
	</TD>
	</TR>
	<br>
	<TD COLSPAN=2>
