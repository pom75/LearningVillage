...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<title>Learning village - creation de message</title>
...
?>
   ...
   <?php  } ?>
		...
		<div id="corps">
			<h1>Question a l'Eleve numero 12 : Ferreira Stephane</h1>
			
			<FORM method=post <!--action="themeacc.php--><? echo '?id='.$_GET['id']; ?>">	
			<TR>
			<TD>intitule du message</TD><br>
			<TD>
			<TEXTAREA rows="1" cols="13" name="nomlecon"></TEXTAREA>
			</TD>
			</TR>	
			<br>
			<TR>
